...
export function Header() {
  ...
  return (
    <header
      className={
        isHomepage
          ? "sticky top-0 z-50 border-b border-brand-border/70 bg-white/95 shadow-[0_2px_14px_rgb(15_23_42/0.04)] backdrop-blur-lg"
          : "sticky top-0 z-50 border-b border-brand-border/60 bg-white/90 shadow-[0_1px_0_rgb(255_255_255/0.8)_inset,0_1px_12px_rgb(15_23_42/0.04)] backdrop-blur-lg"
      }
    >
      <div
        className={
